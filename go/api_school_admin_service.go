...
func (s *SchoolAdminApiService) GetSettings(ctx context.Context) (ImplResponse, error) {
...
func (s *SchoolAdminApiService) SetSettings(ctx context.Context, settings Settings) (ImplResponse, error) {
