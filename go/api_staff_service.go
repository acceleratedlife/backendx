...
func (s *StaffApiService) AuctionsAllStream(ctx context.Context) (ImplResponse, error) {
	// TODO - update AuctionsAllStream with the required logic for this service method.
	// Add api_staff_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("AuctionsAllStream method not implemented")
}
...
func (s *StaffApiService) StreamAuctionsTeacher(ctx context.Context) (ImplResponse, error) {
	// TODO - update StreamAuctionsTeacher with the required logic for this service method.
	// Add api_staff_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("StreamAuctionsTeacher method not implemented")
}
