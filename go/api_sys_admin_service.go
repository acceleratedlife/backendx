...
func (s *SysAdminApiService) DeleteUser(ctx context.Context, email string) (ImplResponse, error) {
	...
	//TODO: Uncomment the next line to return response Response(200, InlineResponse20019{}) or use other options such as http.Ok ...
	//return Response(200, InlineResponse20019{}), nil
